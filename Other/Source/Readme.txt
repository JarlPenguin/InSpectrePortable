DEVELOPER: Replace the three occurrences of InSpectrePortable in this file
...
user in an INI file next to InSpectrePortable.exe called InSpectrePortable.ini.
...
copy AppNamePortable.ini from this directory to InSpectrePortable.ini next to
InSpectrePortable.exe. The options in the INI file are as follows:
